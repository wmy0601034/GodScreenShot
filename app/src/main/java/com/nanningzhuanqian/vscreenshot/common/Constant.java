package com.nanningzhuanqian.vscreenshot.common;
...
public class Constant {
    ...
    public static final String KEY_CONTRACT_QQ = "contractQQ";
    ...
    public static final int REQUEST_CODE_PROMPT_EDIT = 1012;

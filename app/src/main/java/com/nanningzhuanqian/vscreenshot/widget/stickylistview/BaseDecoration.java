package com.nanningzhuanqian.vscreenshot.widget.stickylistview;
...
import com.nanningzhuanqian.vscreenshot.widget.stickylistview.listener.OnGroupClickListener;
                    ...
                    if (value.mDetailInfoList == null || value.mDetailInfoList.size() == 0) {
                        ...
                        for (ClickInfo.DetailInfo detailInfo : list) {
                            if (detailInfo.top <= y && y <= detailInfo.bottom
                                ...
                                //当前view被点击
                                Log.i(getClass().getSimpleName(),"当前view被点击");
                        ...
                        if (!isChildViewClicked) {
                            ...
                            Log.i(getClass().getSimpleName(),"点击范围不在带有id的子view中，则表示整个groupView被点击");
                            onGroupClick(entry.getKey(), value.mGroupId);
                        }

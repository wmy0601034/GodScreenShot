...
public class ContractLite {
    ...
    public ContractLite(int type, String name, int imgRes, String imgUrl, int imgType) {
        this.type = type;
        this.name = name;
        this.imgRes = imgRes;
        this.imgUrl = imgUrl;
    ...
    public ContractLite(int type, String name, int imgRes,String pointToUser) {
        this.type = type;
        this.name = name;
        this.imgRes = imgRes;
    ...
    public ContractItem convertToContractItem(){
        return new ContractItem(type,name,imgRes,pointToUser);
    }
